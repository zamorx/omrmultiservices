          ...
          <div class="row">
            ...
            <div class="col-xl-2 col-md-4 col-6">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><strong class="text-uppercase">Servicios</strong><span>Registrados</span>
            ...
            <div class="col-xl-2 col-md-4 col-6">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><strong class="text-uppercase">Ordenes</strong><span>Pendientes</span>
            ...
            <div class="col-xl-2 col-md-4 col-6">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><strong class="text-uppercase">Ordenes</strong><span>Completadas</span>
          ...
          <div class="row d-flex align-items-md-stretch">
            ...
            <div class="col-lg-3 col-md-6">
              <div class="card to-do">
                <h2 class="display h4">Entregas Pendientes</h2>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="card project-progress">
                <h2 class="display h4">Gráfica de Servicios</h2>
                <p> Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
                <div class="pie-chart">
            ...
            <div class="col-lg-6 col-md-12 flex-lg-last flex-md-first align-self-baseline">
              <div class="card sales-report">
                <h2 class="display h4">Reporte de Ventas</h2>
